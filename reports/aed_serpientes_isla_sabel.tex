...
%% \begin{abstract}
%% Presentamos un análisis exploratorio de datos de las medidas morfométricas, de serpiente falsa coralillo en Isla %% Isabel en el periodo de 2008 al 2014. Calculamos un resumen de cinco números, y
%% utilizamos diagramas de cajas de para visualizar los resultados. Encontramos que no hay grandes diferencias, %% entre temporadas.
%% \end{abstract}
