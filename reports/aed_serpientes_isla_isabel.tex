...
\small{martha.jimenez@islas.org.mx}} \title{Análisis Exploratorio de Datos Serpientes Falsa Coralillo en Isla Isabel del 2008 al 2014\\
\begin{large} Grupo de Ecología y Conservación de Islas \end{large}}  

\maketitle

\begin{abstract}
Presentamos un análisis exploratorio de datos de las medidas morfométricas de \py{len(snakes_data)}
...
el minimo, max es el maximo y $Q_1$, $Q_2$ y $Q_3$ son los cuartiles uno, dos y tres
respectivamente.}
\vspace{0.5cm}
